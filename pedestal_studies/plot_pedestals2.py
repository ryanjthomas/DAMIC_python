#!/usr/bin/ipython -i
#Ad hoc for displayinhg random stuff
...
if __name__=="__main__":
  ...
  run4=[x for x in range(2000,3000)]
  ...
  for idx, (run, run_number) in enumerate(zip(runs, run_numbers)):
    directory="/data/damic/snolab/raw/DAMIC_SNOLAB_RUN1/Jan2017/sci/140K/cryoOFF/100000s-IntW800-OS/1x100/run3/"
    ...
    fname=directory+"d44_snolab_Int-800_Exp-100000_"+str(run).zfill(4)+".fits.fz"
  ...
  for i, extension in enumerate([4]):
